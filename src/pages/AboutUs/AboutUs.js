            ...
            <Fragment>
                ...
                <section className={styles.about_us}>
                    <div className={styles.about_us__banner_info}>
                        ...
                        <p>
                            Основная задача нашего проекта – сделать процесс записи к врачу максимально прозрачным,
                            удобным и быстрым.
                            Ежедневно команда экспертов своего дела, старается сделать невозможное для того, чтобы у
                            наших пациентов
                            была возможность получать только самые качественные услуги от высококвалифицированных
                            специалистов.
                        </p>
                    </div>
                </section>
                ...
                <section className={styles.about_us__info}>
                    ...
                    <p>
                        IMED — это сервис по поиску врачей. Мы стремимся помочь людям оперативно найти хорошего доктора
                        и
                        записаться к нему на приём. Для этого мы создали базу врачей, собираем отзывы у пациентов после
                        приёма и
                ...
                <section className={styles.about_us__advantages}>
                    ...
                    <div className={styles.about_us__advantages_item}>
                        ...
                        <p>IMED публикует проверенные отзывы пациентов, которые помогут вам найти нужного
                            специалиста.</p>
                    </div>
