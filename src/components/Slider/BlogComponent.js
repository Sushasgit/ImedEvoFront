            ...
            <section className={`container ${styles.blog}`}>
                <article className={styles.article}>
                    ...
                    <p className={styles.article__description}>
                        Детская кожа у детей нежнее и тоньше, чем у взрослых, поэтому реагирует на холод быстрее и
                        дольше.
                    </p>
                ...
                <article className={styles.article}>
                    ...
                    <p className={styles.article__description}>
                        Летняя жара доставляет немало хлопот даже тем беременным, которые знают о токсикозе только от
                        подруг. Во многих случаях...
                    </p>
                    <Link to="/blog" className={styles.article__btn}>Читать дальше</Link>
                </article>
