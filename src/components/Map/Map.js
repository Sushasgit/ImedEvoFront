                ...
                >
                    ...
                    <InfoBox
                        ...
                        <div className={styles.doctor__card}>
                            <img className={styles.doctor__img}
                                 src='http://www.sibs-visa.com/wp-content/uploads/2014/07/vrach.jpg' alt='doctor'/>
                            <div className={styles.main_info}>
                                <h2 className={styles.doctor__name}><span>{a.firstname}</span> <span>{a.lastname}</span>
                                </h2>
                            ...
                            <div>
                                <div className={styles.doctor__card}>
                                    <img className={styles.doctor__img} src={logo}
                                         alt="clinic"/>
                                    <div className={styles.main_info}>
                                        <h2 className={styles.doctor__name}><span>{a.firstname}</span>
                                            <span>{a.lastname}</span></h2>
                    ...
                    <section className={styles.infobox}>
                        <InfoBox
                            ...
                            <div>
                                <div className={styles.doctor__card}>
                                    <img className={styles.doctor__img}
                                         src={require('../../images/placeholder-clinic.png')}
                                         alt="laboratory"/>
                                    <div className={styles.main_info}>
                                        <h2 className={styles.doctor__name}><span>{a.firstname}</span>
                                            <span>{a.lastname}</span></h2>
